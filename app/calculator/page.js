      ...
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {/* iPhone 13 */}
            <Link href="/faq">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer hover:opacity-95 transition-opacity">
                <div className="p-4">
            ...
            {/* iPhone 14 */}
            <Link href="/faq">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden relative cursor-pointer hover:opacity-95 transition-opacity">
